...
%% Goldbach’s Conjecture is one of the most famous unsolved math problems in the world. It states that every even integer greater than two can be expressed as the sum of two primes. The conjecture is named after Christian Goldbach, a German mathematician who proposed it in 1742...
...
\begin{center}
    \includegraphics[width=3in]{images/goldbach-comet.png}
\end{center}
...
\begin{center}
    \includegraphics[width=3in]{images/stick_figure1.png}
\end{center}
\end{document}
