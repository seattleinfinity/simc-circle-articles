...
\begin{center}
    \includegraphics[width=2in]{images/golden-ratio.png}
\end{center}
...
\begin{center}
    \includegraphics[width=2in]{images/golden-ratio3.png}
\end{center}
...
\begin{center}
   \includegraphics[width=2in]{images/golden-ratio4.png}
\end{center}
...
\begin{center}
    \includegraphics[width=2in]{images/golden-ratio5.png}
\end{center}
