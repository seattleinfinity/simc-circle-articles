...
%% \blurb{Let's say we have a triangle. What's more, let's make all three sides of the triangle have the same length--it's *equilateral*. Now, remember how we learned *transformations* ages and ages ago? We're going to look at the transformations that preserve the triangle.}
